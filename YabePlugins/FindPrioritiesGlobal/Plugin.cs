...
namespace FindPrioritiesGlobal
{
    public class Plugin : IYabePlugin
    {
        ...
        public void Init(YabeMainDialog yabeFrm) // This is the unique mandatory method for a Yabe plugin 
        {
            ...
            MenuItem.Text = "FindPrioritiesGlobal";
        ...
        public void MenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Trace.WriteLine("Loading FindPrioritiesGlobal window...");
                FindPrioritiesGlobal frm = new FindPrioritiesGlobal(this._yabeFrm);
                frm.Show();
            }
            catch
            {
                Cursor.Current = Cursors.Default;
                Trace.Fail("Failed to load the FindPrioritiesGlobal window.");
            }
        }
    }
}
